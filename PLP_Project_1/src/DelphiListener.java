...
public interface DelphiListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DelphiParser#implementsClause}.
	 * @param ctx the parse tree
	 */
	void enterImplementsClause(DelphiParser.ImplementsClauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#implementsClause}.
	 * @param ctx the parse tree
	 */
	void exitImplementsClause(DelphiParser.ImplementsClauseContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link DelphiParser#classModifiers}.
	 * @param ctx the parse tree
	 */
	void enterClassModifiers(DelphiParser.ClassModifiersContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#classModifiers}.
	 * @param ctx the parse tree
	 */
	void exitClassModifiers(DelphiParser.ClassModifiersContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link DelphiParser#propertyDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterPropertyDeclaration(DelphiParser.PropertyDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#propertyDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitPropertyDeclaration(DelphiParser.PropertyDeclarationContext ctx);
	/**
	 * Enter a parse tree produced by {@link DelphiParser#classVariableDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterClassVariableDeclaration(DelphiParser.ClassVariableDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#classVariableDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitClassVariableDeclaration(DelphiParser.ClassVariableDeclarationContext ctx);
}